...
> [!WARNING]
> Real-provider execution is the next validation phase for v0.3.1. The command surface exists, but this release is not yet live-provider certified.
...
"Implemented" means the adapter exists in the codebase. It does **not** mean that every adapter has been live-certified against a real provider account in v0.3.1.
...
- v0.3.1 is **not yet live-provider certified**; real-provider and larger mock-project dogfooding is next.
