...
def run_autonomous_adapter(
    ...
    *,
    ...
    from saberops.sandbox.policy import grant_for_sandbox
...
def persist_autonomous_trace(
    ...
    *,
    ...
    zero effects.
    """
    from saberops.models import EffectStatus, ReconciliationStatus
    from saberops.observability.trace import AttemptTraceRecorder
    from saberops.sandbox import SideEffectSemantics
    from saberops.sandbox.enforcement import boundary_evidence_for
...
def sandboxed_child_write_text(
    ...
    *,
    ...
    from saberops.sandbox.enforcement import preflight_write
...
def _terminate_group_and_reap(
    ...
    :func:`saberops.monitor.terminate_group_confirmed` covers the whole
...
def run_process(
    ...
    Args:
        ...
        worker_monitor: Optional :class:`saberops.monitor.WorkerMonitor`
    ...
    if on_process_start is not None:
        try:
            from saberops.ownership import ProcessIdentity as _ProcId
    ...
    if _monitor is None and (
        ...
        try:
            from saberops import monitor as _mon_mod
            from saberops.monitor import WorkerMonitor as _WM
            _monitor = _WM(
                proc.pid,
        ...
        try:
            ...
            while True:
                ...
                if _monitor is not None and not monitor_stall_terminated:
                    try:
                        from saberops.monitor import MonitorState as _MS
