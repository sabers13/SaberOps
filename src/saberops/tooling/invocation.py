...
from saberops.models import SideEffectOperation
...
from saberops.tooling.generator import verify_artifact
    ...
    def invoke(
        ...
        *,
        ...
        if binding.transport == ToolTransport.NATIVE_MCP:
            raise ToolInvocationBlocked("native MCP is a declaration-only fallback")
