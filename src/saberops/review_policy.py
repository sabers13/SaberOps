"""Bounded Reviewer Authority: pure review-policy core.
...
enforced disposition are impossible by construction. It has no persistence,
adapter, clock, or randomness dependencies.
"""
...
def classify_review_risk(task_text: str, changed_paths: Sequence[str] = ()) -> ReviewRiskAssessment:
    ...
    In the transparent style of :mod:`saberops.classifier`: each
