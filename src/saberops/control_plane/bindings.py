...
is owned exclusively by :mod:`saberops.control_plane.quota_policy`
and consulted by :func:`saberops.control_plane.preflight.evaluate_control_plane`.
"""
...
class QuotaPool:
    ...
    :class:`saberops.control_plane.quota_policy.QuotaPoolPolicy`
    inside :class:`saberops.control_plane.policy.ControlPlanePolicy`
    and is consulted by the single canonical C07 evaluator
    (:func:`saberops.control_plane.preflight.evaluate_control_plane`).
...
class ExecutionBinding:
    ...
    * identify the scarcity pool it consumes (``quota_pool_id``); the
      ...
      :class:`saberops.control_plane.policy.ControlPlanePolicy.quota_pools`;
    ...
    * mark when its declaration was last verified (``verified_at``).
    ...
    def capability_profile_descriptor(self) -> dict[str, Any]:
        ...
        :func:`saberops.control_plane.capabilities.capability_profile_for`
...
def _copilot_overlay(
    *,
    ...
    with no overlay.
    """
    from saberops.workers.copilot import copilot_overlay_for_binding
