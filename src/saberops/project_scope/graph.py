...
from saberops.devscope.paths import match_any
...
from saberops.project_scope.metadata import (
    PROJECT_FILE,
    ExplicitModule,
    ProjectMetadata,
...
from saberops.project_scope.python_analyzer import (
    PythonAnalysis,
...
def _load_f01_metadata(root: Path) -> ProjectMetadata | None:
    ...
    if not modules_dir.is_dir():
        return None
    from saberops.devscope.manifest import ManifestError, load_manifests
