...
#: Strategy-evidence key for a positively bound security-policy identity.
...
def _build_summary(
    ...
    lines: list[str] = [
        "BOUNDED TOOL-OUTPUT OBSERVATION CAMPAIGN — OBSERVATIONS ONLY",
        "=" * 64,
        "",
    ...
    lines.extend(
        [
            ...
            "campaign environment; canonical effort resolution owns that "
            "authority and this campaign adds no substitute resolver.",
            "",
            "COMPOSITE: NOT_AVAILABLE — existing capability and trace primitives authorize "
