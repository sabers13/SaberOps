"""CLI entry point for inspecting and running SaberOps real-project replays.
...
from saberops.replay.corpus import get_corpus_task, get_initial_corpus
from saberops.replay.experiment import run_c12b_experiments
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="python -m saberops.replay",
        description="SaberOps replay and measurement devtool.",
    )
    ...
    run_parser = subparsers.add_parser(
        "run-experiments",
        help="Run the bounded context/cache campaign on real frozen corpus tasks.",
    )
