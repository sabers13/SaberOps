...
Note: orch_accept and orch_cleanup are restricted from automated execution to uphold
fail-closed safety and require explicit human confirmation in the browser UI.
"""
# ruff: noqa: E501
