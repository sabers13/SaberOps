...
Deliberately separate from ``orchestrator_mvp.cli``: devscope is dev-time
...
from orchestrator_mvp.devscope import affected as affected_mod
from orchestrator_mvp.devscope import context as context_mod
from orchestrator_mvp.devscope.architecture import check_architecture, report_to_dict
from orchestrator_mvp.devscope.manifest import ManifestError
from orchestrator_mvp.devscope.paths import repo_root
from orchestrator_mvp.devscope.repomap import build_repo_map, render_repo_map, repo_map_json
from orchestrator_mvp.devscope.scope import resolve_scope
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="python -m orchestrator_mvp.devscope",
...
def main(argv: list[str] | None = None) -> int:
    """Entry point for ``python -m orchestrator_mvp.devscope``."""
