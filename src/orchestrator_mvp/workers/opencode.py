...
from orchestrator_mvp.telemetry import parse_opencode_jsonl
from orchestrator_mvp.workers.base import WorkerAdapter, streaming_process_kwargs
from orchestrator_mvp.workers.instruction_compat import (
...
class OpenCodeAdapter(WorkerAdapter):
    ...
    def instruction_compatibility(self, model: str) -> InstructionCompatibility:
        ...
        :mod:`orchestrator_mvp.workers.instruction_compat` for the
