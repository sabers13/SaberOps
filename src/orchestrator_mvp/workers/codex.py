...
from orchestrator_mvp.models import AttemptStatus, DispatchOutcome, WorkerRequest, WorkerResult
...
from orchestrator_mvp.telemetry import parse_codex_jsonl
from orchestrator_mvp.workers.base import WorkerAdapter, streaming_process_kwargs

__all__ = ["CodexAdapter", "ORCH_PROMPT_ARG_LIMIT"]


# Gateway-aware env-var names published by :mod:`orchestrator_mvp.gateway`.
...
class CodexAdapter(WorkerAdapter):
    ...
    :func:`orchestrator_mvp.gateway.prepare_dispatch_decision`), the
