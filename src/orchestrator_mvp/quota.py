...
from orchestrator_mvp.models import QuotaRawSemantics, QuotaState, RoutingState, WorkerCandidate
...
def apply_c07_quota_to_chain(
    ...
    *,
    ...
    """
    from orchestrator_mvp.control_plane import quota_decision
