...
from orchestrator_mvp.project_scope.contracts import ProjectScope
from orchestrator_mvp.project_scope.persistence import (
    ScopeBundle,
    load_scope_bundle,
    record_expansion,
)
from orchestrator_mvp.project_scope.resolver import MAX_INTERFACE_PATHS, closure_modules
