...
class ReplayEngine:
    ...
    def run_verifier(
        ...
        """
        from orchestrator_mvp.process import run_sandboxed_process
        from orchestrator_mvp.sandbox import (
            NetworkPolicy,
            ProcessPolicy,
            SandboxPolicy,
            bwrap_available,
    ...
    def execute_replay(
        ...
        *,
        ...
        if evidence_dir is not None:
            ...
            from orchestrator_mvp.replay.workspace import get_replay_worktree_base
