...
_DECLARED_WORK_ITEMS: Final[dict[str, tuple[ParallelWorkItem, ...]]] = {
    "orch-v2-task-01-bounded-change": (
        ParallelWorkItem(
            ...
            scope_paths=("src/orchestrator_mvp/projects.py", "tests/test_projects.py"),
        ...
        ParallelWorkItem(
            ...
            scope_paths=("src/orchestrator_mvp/process.py", "tests/test_process.py"),
            independence=INDEPENDENCE_ESTABLISHED,
        ),
    ),
}
...
def _build_summary(
    ...
    lines: list[str] = [
        "C12-D BOUNDED PARALLELISM CAMPAIGN — OBSERVATIONS ONLY",
        "=" * 54,
        "",
    ...
    lines.extend(
        [
            ...
            "replay environment; concurrent Attempts are representable (C11-D "
            "ownership) but not executable here, and C12-D builds no replacement "
            "scheduler.",
