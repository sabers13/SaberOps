...
from orchestrator_mvp.project_scope import graph as project_scope_graph
from orchestrator_mvp.project_scope.contracts import ProjectGraph, ProjectModule, ProjectScope
from orchestrator_mvp.project_scope.persistence import (
    ProjectScopeIntegrityError,
    load_scope_bundle,
)
from orchestrator_mvp.slicing import ProposedPackage, TaskSizingAssessment
...
# (see ``orchestrator_mvp.sandbox.policy.GIT_INTERNAL_DENY`` /
