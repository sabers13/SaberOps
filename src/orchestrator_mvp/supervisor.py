...
:mod:`orchestrator_mvp.ownership`), claimed atomically *before* any process is
...
from orchestrator_mvp.git import _CANDIDATE_BRANCH_RE, GitManager, assert_repository_at_revision
...
from orchestrator_mvp.project_scope.persistence import freeze_run_scope
...
from orchestrator_mvp.tooling import ToolRegistry, freeze_tool_contract
...
class RunSupervisor:
    ...
    def observe_long_worker(
        ...
        *,
        ...
        if health == HealthState.HEALTHY:
            from orchestrator_mvp.handoff import create_handoffs
    ...
    def _build_recovery_cli_args(self, run_id: str, config: RunConfig) -> list[str]:
        ...
        """
        from orchestrator_mvp.web import resolve_orch_executable
