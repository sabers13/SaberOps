"""Local web dashboard for orchestrator-mvp.
...
from orchestrator_mvp.manager import ManagerClient, ManagerService, OpenCodeManagerClient
from orchestrator_mvp.model_access import (
    ACCOUNT_BACKENDS,
    AccessProtocol,
    AccessStore,
    AccessStoreError,
...
from orchestrator_mvp.provenance import assert_run_repository
...
from orchestrator_mvp.runtime import ProjectRuntime, ProjectRuntimeManager
    ...
    def routing_add(
        ...
        if exact_binding is None:
            return templates.TemplateResponse(
                ...
                _routing_context(
                    error=(
                        "Model cannot enter routing: no exact executable C11-B "
