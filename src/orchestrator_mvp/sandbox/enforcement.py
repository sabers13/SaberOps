...
in :mod:`orchestrator_mvp.process`, which the execution module owns)
...
from orchestrator_mvp.sandbox.exposure import ToolExposurePlan
from orchestrator_mvp.sandbox.grants import (
    CapabilityOperation,
    SandboxContractError,
    ToolGrant,
)
from orchestrator_mvp.sandbox.policy import SandboxPolicy
