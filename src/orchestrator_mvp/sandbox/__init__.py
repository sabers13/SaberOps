...
boundary.  See :mod:`orchestrator_mvp.sandbox.grants`,
:mod:`orchestrator_mvp.sandbox.policy`, and
:mod:`orchestrator_mvp.sandbox.exposure`.
"""
...
from orchestrator_mvp.sandbox.exposure import (
    ExposureEntry,
    ExposureMechanism,
    ToolExposurePlan,
)
