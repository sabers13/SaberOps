...
:meth:`orchestrator_mvp.db.Database.claim_execution_owner`) and is deliberately
...
def _group_has_members(pgid: int) -> bool:
    ...
    """
    from orchestrator_mvp.monitor import group_has_live_members
...
def worker_identity_fences_ok(identity_json: str | None) -> bool:
    ...
    from orchestrator_mvp.db import _decode_process_identity
...
def terminate_worker_group_fenced(
    ...
    *,
    ...
    (:func:`orchestrator_mvp.monitor.terminate_group_confirmed`): SIGTERM,
